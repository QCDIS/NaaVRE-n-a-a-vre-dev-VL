...
arg_parser.add_argument('--norm_tiles', action='store', type=list, required='True', dest='norm_tiles')
...
arg_parser.add_argument('--param_feature_name', action='store', type=list, required='True', dest='param_feature_name')
