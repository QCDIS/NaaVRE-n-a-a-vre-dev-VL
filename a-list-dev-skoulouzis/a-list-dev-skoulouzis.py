...
arg_parser.add_argument('--param_3', action='store', type=str, required='True', dest='param_3')
arg_parser.add_argument('--param_5', action='store', type=str, required='True', dest='param_5')
arg_parser.add_argument('--param_6', action='store', type=str, required='True', dest='param_6')
...
arg_parser.add_argument('--param_f', action='store', type=str, required='True', dest='param_f')
